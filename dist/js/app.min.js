(() => {
          ...
          void 0 !== a &&
            ...
            (g(e[n]) && g(i[n])
              ? i[n].__swiper__
                ...
                : b(e[n], i[n])
              : !g(e[n]) && g(i[n])
              ? ((e[n] = {}), i[n].__swiper__ ? (e[n] = i[n]) : b(e[n], i[n]))
              : (e[n] = i[n]));
        }
      }
    }
      ...
      updateSlides: function () {
        ...
        if (
          ...
          w(e.wrapperEl, '--swiper-centered-offset-before', -u[0] + 'px'),
            w(e.wrapperEl, '--swiper-centered-offset-after', e.size / 2 - f[f.length - 1] / 2 + 'px');
      ...
      slideTo: function (e, t, s, i, n) {
        ...
        if (l.cssMode) {
          ...
          if (0 === t) {
            ...
            if (!a.support.smoothScroll) return C({ swiper: a, targetPosition: s, side: e ? 'left' : 'top' }), !0;
  ...
  const B = (e, t) => {
      ...
      (n.preventClicks || n.preventClicksPropagation) && r[p]('click', e.onClick, !0),
        ...
        n.updateOnWindowResize
          ? e[u](o.ios || o.android ? 'resize orientationchange observerUpdate' : 'resize observerUpdate', z, !0)
    ...
    N = {
      attachEvents: function () {
        ...
        (e.onTouchStart = L.bind(e)),
          ...
          s.cssMode && (e.onScroll = A.bind(e)),
          (e.onClick = I.bind(e)),
          n.touch && !D && (t.addEventListener('touchstart', G), (D = !0)),
          B(e, 'on');
      },
        ...
        translateTo: function (e, t, s, i, n) {
          ...
          if (((c = i && e > o ? o : i && e < d ? d : e), a.updateProgress(c), r.cssMode)) {
            ...
            if (0 === t) l[e ? 'scrollLeft' : 'scrollTop'] = -c;
              ...
              if (!a.support.smoothScroll) return C({ swiper: a, targetPosition: -c, side: e ? 'left' : 'top' }), !0;
      ...
      transition: {
        ...
        transitionStart: function (e, t) {
          ...
          const s = this,
            { params: i } = s;
          i.cssMode ||
            (i.autoHeight && s.updateAutoHeight(), $({ swiper: s, runCallbacks: e, direction: t, step: 'Start' }));
        },
        transitionEnd: function (e, t) {
          ...
          const s = this,
            { params: i } = s;
          (s.animating = !1),
            i.cssMode || (s.setTransition(0), $({ swiper: s, runCallbacks: e, direction: t, step: 'End' }));
        },
      },
      slide: k,
      loop: P,
  ...
  class R {
    constructor() {
      ...
      (r.__swiper__ = !0),
        (r.support = E()),
        (r.device =
          (void 0 === (l = { userAgent: t.userAgent }) && (l = {}),
          T ||
            (T = (function (e) {
              ...
              ((r = new ResizeObserver(e => {
                l = n.requestAnimationFrame(() => {
                  ...
                  e.forEach(e => {
                    ...
                    (r && r !== t.el) ||
                      ((n = i ? i.width : (s[0] || s).inlineSize), (a = i ? i.height : (s[0] || s).blockSize));
                  }),
                    (n === s && a === i) || o();
                });
              })),
  ...
  function U(e) {
    ...
    function p() {
      const { $nextEl: e, $prevEl: s } = t.navigation;
      e && e.length && (e.off('click', d), e.removeClass(t.params.navigation.disabledClass)),
    ...
    s({
      ...
      i('click', (e, s) => {
        const { $nextEl: i, $prevEl: a } = t.navigation,
          r = s.target;
        if (t.params.navigation.hideOnClick && !h(r).is(a) && !h(r).is(i)) {
          if (
            t.pagination &&
            t.params.pagination &&
  ...
  function Z(e) {
    ...
    function c() {
      ...
      if (
        ('fraction' === s.type &&
          (a.find(K(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
          a.find(K(s.totalClass)).text(s.formatFractionTotal(p))),
        'progressbar' === s.type)
      ) {
        let e;
    ...
    function p() {
      ...
      if ('bullets' === e.type) {
        ...
        i.html(a), (t.pagination.bullets = i.find(K(e.bulletClass)));
      }
      'fraction' === e.type &&
        ((a = e.renderFraction
    ...
    function u() {
      ...
      0 !== s.length &&
        (t.params.uniqueNavElements &&
          'string' == typeof e.el &&
          s.length > 1 &&
          ((s = t.$el.find(e.el)), s.length > 1 && (s = s.filter(e => h(e).parents('.swiper')[0] === t.el))),
    ...
    (s.autoplay = { running: !1, paused: !1 }),
      ...
      a('init', () => {
        s.params.autoplay.enabled &&
          ...
          s.params.autoplay.pauseOnMouseEnter && (s.$el.on('mouseenter', h), s.$el.on('mouseleave', m)));
      }),
  ...
  (() => {
    const e = document.querySelector('.header-menu__btn'),
      t = document.querySelector('.header-search__btn'),
      s = document.querySelector('.mobile__menu'),
      i = document.querySelector('.mobile__search'),
      n = document.querySelectorAll('.mobile__sublist, .mobile__list-btn img');
    document.addEventListener('click', a => {
      a.target === e
        ...
        : a.target === t
        ? (s.classList.remove('active'), e.classList.remove('active'), i.classList.toggle('active'))
        : a.target.closest('.mobile__list-btn') &&
          (e => {
            e.preventDefault();
            const t = e.target.closest('.mobile__list-item'),
              s = t.querySelector('.mobile__list-btn'),
              i = t.querySelector('.mobile__sublist');
            s.querySelector('img').classList.toggle('active'), i.classList.toggle('active');
          })(a);
    });
  })(),
    (() => {
      const e = {
          ...
          navigation: { nextEl: '.brands__slider-next', prevEl: '.brands__slider-prev' },
        },
        t = {
          modules: [U, Z],
          loop: !0,
          pagination: { el: '.categories__slider-dots' },
          navigation: { nextEl: '.categories__slider-next', prevEl: '.categories__slider-prev' },
        },
        s = {
          modules: [U, Z],
          loop: !0,
          spaceBetween: 24,
          breakpoints: { 576: { slidesPerView: 2 }, 991: { slidesPerView: 3 } },
          pagination: { el: '.exposition__slider-dots' },
        },
        i = { modules: [U, Z, J], loop: !0, autoplay: { delay: 3e3 }, pagination: { el: '.post__slider-dots' } },
        n = (e, t) => {
          new X(`.swiper.${e}__slider`, t);
        },
        a = e => {
          new X(`.swiper.${e}__slider`, {
            modules: [U, Z],
            loop: !0,
            spaceBetween: 23,
            breakpoints: {
            ...
            pagination: { el: `.${e}__slider-dots` },
            navigation: { nextEl: `.${e}__slider-next`, prevEl: `.${e}__slider-prev` },
          });
        };
      n('events', {
        modules: [U, Z, J],
        ...
        autoplay: { delay: 5e3 },
        pagination: { el: '.events__slider-dots' },
        navigation: { nextEl: '.events__slider-next', prevEl: '.events__slider-prev' },
      }),
        n('brands', e),
        n('categories', t),
        n('exposition', s),
      ...
      (() => {
        const e = (e, t) => {
          ...
          [
            ...
            'fullscreenControl',
            'zoomControl',
          ].forEach(t => e.controls.remove(t)),
            e.behaviors.disable(['scrollZoom']),
            e.geoObjects.add(s);
        };
        ymaps.ready(function () {
          const t = [54.168413, 37.586198];
          let s = new ymaps.Map('affiche-map', { center: t, zoom: 18 });
          e(s, t);
        }),
          ymaps.ready(function () {
            const t = [54.195535, 37.610476];
            let s = new ymaps.Map('complex-map', { center: t, zoom: 18 });
            e(s, t);
          }),
          ymaps.ready(function () {
            const t = [54.168288, 37.585503];
            let s = new ymaps.Map('post-map', { center: t, zoom: 18 });
            e(s, t);
          });
      })();
})();
